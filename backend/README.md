...
- [JavaScript Debugger](https://marketplace.visualstudio.com/items?itemName=ms-vscode.js-debug) - Built-in Node.js debugger
...
- Use correct working directories for multi-root workspace
