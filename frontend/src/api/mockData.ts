...
export const FILTER_TAGS: FilterTag[] = [
    {
        label: 'SoW',
        icon: '/documents/sow-g.svg',
        activeIcon: '/documents/sow-w.svg',
    },
    {
        label: 'Legal',
        icon: '/documents/shield-g.svg',
        activeIcon: '/documents/shield-w.svg',
    },
    {
        label: 'Billing',
        icon: '/documents/biling-g.svg',
        activeIcon: '/documents/biling-w.svg',
    },
    {
        label: 'Assets',
        icon: '/documents/asset-g.svg',
        activeIcon: '/documents/asset-w.svg',
    },
];
...
// ===== HELPER FUNCTIONS =====
export const getUniqueVersions = () =>
    [...new Set(MOCK_FILES.map((f) => f.version))].sort();
export const getUniqueUploaders = () =>
    [...new Set(MOCK_FILES.map((f) => f.uploader.name))].sort();
export const getUniqueStatuses = () => [
    ...new Set(MOCK_FILES.map((f) => f.status)),
];
