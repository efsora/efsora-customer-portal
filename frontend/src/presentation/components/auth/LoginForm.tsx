        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <div data-testid="login-form-email-field">
                            <label
                                htmlFor="email"
                                className="sr-only"
                            >
                        ...
                        <div data-testid="login-form-password-field">
                            <label
                                htmlFor="password"
                                className="sr-only"
                            >
                    ...
                    <div data-testid="login-form-submit-container">
                        <button
                            type="submit"
                            disabled={isPending}
                    ...
                    <div
                        ...
                        data-testid="login-form-signup-section"
                    >
